...
// return gregration date even before 1582-10-15 12:00:00
func ExampleJDToTime() {
	fmt.Println(julian.JDToTime(2299161.0))
	fmt.Println(julian.JDToTime(2299160.0))
	// Output:
	// 1582-10-15 12:00:00 +0000 UTC
	// 1582-10-14 12:00:00 +0000 UTC
}
